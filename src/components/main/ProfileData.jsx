...
const ProfileData = () => {
  ...
  return (
    <div className='profile__images'>
      ...
      <div className={`title ${page == "posts" ? "selected" : "" }`} onClick={() =>setPage("posts")}>
      <p>POSTS</p>
      </div>
      <div className={`title ${page == "reels" ? "selected" : "" }`} onClick={() =>setPage("reels")}>
      <p>REELS</p>
      </div>
      <div className={`title ${page == "tagged" ? "selected" : "" }`} onClick={() =>setPage("tagged")}>
      <p>TAGGED</p>
      </div>
      </div>
      ...
      <div className='photo_grid'>
      {
        ...
        <div key={i} className={`single_photo ${single?.like ? "card_effect" : ""}`}> 
